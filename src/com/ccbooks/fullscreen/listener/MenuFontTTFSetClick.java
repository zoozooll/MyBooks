...
import com.chinachip.TextReader.MenuFontTTF;
...
public class MenuFontTTFSetClick implements OnItemClickListener {
	static final String DEBUG_TAG = "jf";
	private MenuSetting funObj;

	public MenuFontTTFSetClick(MenuSetting mc) {
		funObj = mc;
	}

	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		funObj.changeTTFByID(arg2);
	}
}
