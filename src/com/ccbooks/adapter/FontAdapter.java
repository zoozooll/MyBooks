...
public class FontAdapter extends BaseAdapter {
	...
	private ArrayList<FontListItem> list;
	//public List<Book> books;
	private LayoutInflater inflater;
	private int mode;
	
	public FontAdapter(Activity activity,ArrayList<FontListItem> list,int selected){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView == null){
			...
			convertView = (FrameLayout) inflater.inflate(R.layout.fontttf_layout,
				null);
		...
		holder.tvCharactorSelecte.setText(list.get(position).getTtfFileName());
		if (mode == 1) {
